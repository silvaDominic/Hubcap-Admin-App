...
var WTimeComponent = /** @class */ (function () {
    ...
    WTimeComponent.prototype.setCurrentView = function (type) {
        ...
        if (this.currentView === w_clock_component_1.CLOCK_TYPE.HOURS || (!this.minTime && !this.maxTime))
            return;
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], WTimeComponent.prototype, "minTime", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], WTimeComponent.prototype, "maxTime", void 0);
    __decorate([
        core_1.Output(),
